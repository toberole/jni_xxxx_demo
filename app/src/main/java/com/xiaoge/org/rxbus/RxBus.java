 ...
 */
public class RxBus {
    private final FlowableProcessor<Object> flowableProcessor;
    private final SubscriberMethodFinder subscriberMethodFinder;
    private static Map<Class<?>, Map<Class<?>, Disposable>> disposableMap = new HashMap<>();
    ...
    public void register(Object subsciber) {
        ...
        List<SubscriberMethod> subscriberMethods = subscriberMethodFinder.findSubscriberMethods(subsciberClass);
    ...
    private void addSubscriber(final Object subsciber, final SubscriberMethod subscriberMethod) {
        ...
        Disposable disposable = flowableProcessor.ofType(eventType).observeOn(subscriberMethod.getThreadMode())
        ...
        Map<Class<?>, Disposable> disposableMap = RxBus.disposableMap.get(subsciberClass);
        if (disposableMap == null) {
            disposableMap = new HashMap<>();
            RxBus.disposableMap.put(subsciberClass, disposableMap);
        }
    ...
    public void unregister(Object subscriber) {
        ...
        Map<Class<?>, Disposable> disposableMap = RxBus.disposableMap.get(subscriberClass);
        if (disposableMap == null) {
        ...
        RxBus.disposableMap.remove(subscriberClass);
    }
    ...
    public void unregister(Object subscriber, Class<?> eventType) {
        ...
        disposable.dispose();
        RxBus.disposableMap.remove(eventType);
    }
